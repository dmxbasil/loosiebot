...
import loosiebot.modules.sql.global_bans_sql as gban_sql
import loosiebot.modules.sql.users_sql as user_sql
from loosiebot import DEV_USERS, OWNER_ID, dispatcher
