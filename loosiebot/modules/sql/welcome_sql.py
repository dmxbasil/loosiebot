...
from loosiebot.modules.helper_funcs.msg_types import Types
from loosiebot.modules.sql import BASE, SESSION
from sqlalchemy import BigInteger, Boolean, Column, Integer, String, UnicodeText

DEFAULT_WELCOME = "പാടാം നമുക്കു പാടാം... വീണ്ടുമൊരു പ്രേമ ഗാനം .... "
DEFAULT_GOODBYE = "തേചില്ലെ പെണ്ണേ ... തെച്ചില്ലെ പെണ്ണേ... തേപ്പ് പെട്ടി പോലെ വന്നിട്ടെന്നെ.... "
