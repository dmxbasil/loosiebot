...
import loosiebot.modules.sql.notes_sql as sql
from loosiebot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from loosiebot.__main__ import DATA_IMPORT
from loosiebot.modules.helper_funcs.chat_status import user_admin
from loosiebot.modules.helper_funcs.alternate import typing_action

# from loosiebot.modules.rules import get_rules
import loosiebot.modules.sql.rules_sql as rulessql

# from loosiebot.modules.sql import warns_sql as warnssql
import loosiebot.modules.sql.blacklist_sql as blacklistsql
from loosiebot.modules.sql import disable_sql as disabledsql

# from loosiebot.modules.sql import cust_filters_sql as filtersql
# import loosiebot.modules.sql.welcome_sql as welcsql
import loosiebot.modules.sql.locks_sql as locksql
from loosiebot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("loosiebot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("loosiebot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `loosiebot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("loosiebot{}.backup".format(chat_id))  # Cleaning file
