...
import telegram
from loosiebot import TIGERS, WOLVES, dispatcher
from loosiebot.modules.disable import DisableAbleCommandHandler
from loosiebot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from loosiebot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from loosiebot.modules.helper_funcs.string_handling import split_quotes
from loosiebot.modules.log_channel import loggable
from loosiebot.modules.sql import warns_sql as sql
