...
from loosiebot.modules import ALL_MODULES
from loosiebot.modules.helper_funcs.chat_status import is_user_admin
from loosiebot.modules.helper_funcs.misc import paginate_modules
...
PM_START_IMG = "https://telegra.ph/file/398fa181c4e003a8f40c4.jpg"
PM_START_TEXT = """Hello, My name is 《ᴤᴛᴲᴎᴣᴌᴇ᚛〄᚜ᴹᴀᴙᴉᴀ󠀺》

Hey , I am a Group Manager,
Made specially for Managing Groups.

This Pro bot was made by [▼͜͜͜͜͜◣͡͡͡͡͡͡⃟⃟⃟⃟⃟࿅̤❰❰⃘꯭꯭Ꭰᴀʀᴋ💢̶̶꯭꯭꯭꛱͟͟͞❰❰꯭꯭꯭ ⃘Ꭰ꯭ᴇᴠᴉɭ✇࿅͡͡͡͡⃟⃟⃟̤◢͜](https://t.me/Full_Cruel_Mind)
...
buttons = [
   ...
   [
    ...
    [  
        InlineKeyboardButton(text="👥SUPPORT GROUP👥", url="https://t.me/https://t.me/stenzle"),
    ], 
    
]

HELP_STRINGS = """
   @stenZleMaria_bot WITH NEW FEATURES

꧁*CHECK ALL BUTTON BELOW TO EXPLORE EVERY COMMANDS OF TIANA*꧂

𖣘 *All commands can either be used with* `/` *or* `!`.

𖣘 *If you facing any issue or find any bugs in any command then you can report it in @KKK_kovila*
"""


DONATE_STRING ="""CONTACT ME ON @Full_Cruel_Mind"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("loosiebot.modules." + module_name)
